...
class AppData {
  constructor(income = {}, incomeMonth = 0,
    addIncome = [], expenses = {},
    addExpenses = [], deposit = false,
    percentDeposit = 0, moneyDeposit = 0,
    budget = 0, budgetDay = 0,
  ...
  getExpInc() {//считаем дополнит доходы и обязательные расходы
    const count = item => {
